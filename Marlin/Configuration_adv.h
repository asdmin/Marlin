 ...
 */
#define E0_AUTO_FAN_PIN 44 // DaHai: This turns on the Hot-End cooling fan (not the part cooling fan) when the nozzle is heated.
...
//#define SLOWDOWN // amit kaptam abban be volt kapcsolva
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.85  // Unit: mm compression per 1mm/s extruder speed
...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define MAX_AUTORETRACT 5.0             // Upper limit for auto-retract conversion
  #define RETRACT_LENGTH 2                // Default retract length (positive mm)
  #define RETRACT_LENGTH_SWAP 13          // Default swap retract length (positive mm), for extruder change
  #define RETRACT_FEEDRATE 40             // Default feedrate for retracting (mm/s)
  #define RETRACT_ZLIFT 2                 // Default retract Z-lift
